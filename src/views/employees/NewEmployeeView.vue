  ...
  <AppLayout>
    <div class="max-w-2xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Nuevo Empleado</h1>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    toastStore.success('Empleado creado exitosamente')
    router.push('/employees')
  } catch (err) {
    errors.general = err instanceof Error ? err.message : 'Error al crear el empleado'
    toastStore.error('Error al crear el empleado')
  } finally {
    loading.value = false
  }
}
